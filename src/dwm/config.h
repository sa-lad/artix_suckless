...
static const char *fonts[]          = { "Terminus (TTF):size=15:antialias=true" };
static const char dmenufont[]       = "Terminus (TTF):size=15:antialias=true";
static const char col_gray1[]       = "#171717"; /* default: #222222 */
...
/* tagging */
static const char *tags[] = { ">_", "</>", "ssh", "www", "dis", "stm" };
